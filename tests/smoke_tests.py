...
BASE_URL = "https://finapi-pavani-d7b2d4fxgncvf2cf.eastus-01.azurewebsites.net" # <------ Replace with your actual base URL
...
def test_slow_endpoint():
    r = requests.get(f"{BASE_URL}/api/slow-endpoint", timeout=5)
    assert r.status_code == 200
